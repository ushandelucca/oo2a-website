---
title: Wilkommen zur Dokumentation
geekdocNav: false
geekdocAlign: center
geekdocAnchor: false
---
...
Geekdoc ist ein einfaches Hugo-Theme für Dokumentationen. Es ist absichtlich als schnelles und schlankes Thema konzipiert und erfüllt möglicherweise nicht die Anforderungen komplexer Projekte. Wenn ein Theme mit mehr Funktionen benötigt wird, gibt es eine Menge Alternativen.


{{< button size="large" relref="usage/getting-started/" >}}Los geht's{{< /button >}}
...
{{< kroki type="excalidraw" file="example.excalidraw" >}}
